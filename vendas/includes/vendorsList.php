        ...
        $rows .= '
                    <tr class="table-row" id="vendorsTableRow"'.$vendor->Vendor_Id.' data-href="#">
                        <th scope="row">'.$vendor->Vendor_Id.'</th>
                            ...
                            <td>
                                <a class="btn btn-outline-warning" href = "../tray-homework-php-test/?vendorId='.$vendor->Vendor_Id.'&edit">
                            ...
                            <td>
                                <a class="btn btn-outline-danger" href ="../tray-homework-php-test/?vendorId='.$vendor->Vendor_Id.'&delete">
