...
function makeSalesTable()
{
    ...
    $sql = "Select Sale_Id, Sale_Value, Sale_Date From Sale Where Sale_Vendor_Id = " . $_GET['vendorId'] . " and Sale_Status_Id = 1";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<tr class='table-row' id='vendorsTableRow" . $row["Sale_Id"] . "' data-href='#'>
                    ...
                    <td>" . $row["Sale_Date"] . "</td> 
                    <td>
                        <a class='btn btn-outline-warning' href = 'http://localhost/tray-homework-php-test/?vendorId=" . $row['vendorId'] . "&edit'>
                    ...
                    <td>
                        <a class='btn btn-outline-danger' href ='http://localhost/tray-homework-php-test/?vendorId=" . $row['vendorId'] . "&delete'>
