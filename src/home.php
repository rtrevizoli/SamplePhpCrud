...
<script>
    $(document).ready(function($) {
        $(".table-row").click(function() {
            const id = this.id;
            window.document.location = '../tray-homework-php-test/?vendorId=' + id.substr(15) + '&sales';
        });
    });
</script>
<style>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<tr class='table-row' id='vendorsTableRow" . $row["Vendor_Id"] . "' data-href='#'>
                    ...
                    <td>
                        <a class='btn btn-outline-warning' href = '../tray-homework-php-test/?vendorId=" . $row['Vendor_Id'] . "&edit'>
                    ...
                    <td>
                        <a class='btn btn-outline-danger' href ='../tray-homework-php-test/?vendorId=" . $row['Vendor_Id'] . "&delete'>
...
<div class="container py-4" style="width: 80%;">
    <div class="row align-items-start">
        <div class="col-md-2">
            <a class="btn btn-success" style="width: 100%;" href="../tray-homework-php-test/?vendorId&new">
