    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<tr class='table-row' id='vendorsTableRow" . $row["Sale_Id"] . "' data-href='#'>
                    ...
                    <td>" . $row["Sale_Date"] . "</td> 
                    <td>
                        <a class='btn btn-outline-warning' href = '../tray-homework-php-test/?vendorId=" . $vendorId . "&saleId=" . $row["Sale_Id"] . "&edit'>
                    ...
                    <td>
                        <a class='btn btn-outline-danger' href ='../tray-homework-php-test/?vendorId=" . $vendorId . "&saleId=" . $row["Sale_Id"] . "&delete'>
...
<div class="container my-4 py-4" style="width: 80%;">
    <a class="btn btn-success" style="width: 100%;" href="../tray-homework-php-test/?saleId&vendorId=<?php echo $_GET['vendorId']; ?>&new">
